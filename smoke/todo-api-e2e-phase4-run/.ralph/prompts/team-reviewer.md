...
- **`ralph-update-feature-status`** — Mark features as complete (script: `ralph skill update-feature-status`)
- **`ralph-get-feature-stats`** — Check overall progress (script: `ralph skill get-feature-stats`)
